...
function CalcularPrecio () 
{
 	...
 	{	
 		...
 		if(cantidadLamparas==5 && nombreMarca=="ArgentinaLuz")
 		{
 			txtIdprecioDescuento.value = total - (total * 0.40);
 		}
 		else
 			if(cantidadLamparas==5 && nombreMarca!="ArgentinaLuz")
 			{
 			txtIdprecioDescuento.value = total - (total * 0.30);
 		    }
 		    else
 		    	if(cantidadLamparas==4 && (nombreMarca=="ArgentinaLuz" || nombreMarca== "FelipeLamparas"))
 		    	{
...
/*
{}
txtIdCantidad  -- cantidad de lamparas
Marca            -- marca
txtIdprecioDescuento       --- precio con descuento
