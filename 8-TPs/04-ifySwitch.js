...
function CalcularPrecio () 
{
	...
	//txtIdprecioDescuento.value = totalconDescuento; HAY QUE SACARLO
	if(totalconDescuento>120)
	{
		iibb = totalconDescuento*0.10;
		precioConDescyIIBB = totalconDescuento + iibb;
		//txtIdprecioDescuento.value = precioConDescyIIBB; buscar como hacer para que quede afuera, pero que me de en la pagina, tanto para la condicion de con IIBB como Sin!!!!
